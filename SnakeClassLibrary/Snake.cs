...
namespace SnakeClassLibrary
{
    public sealed class Snake
    {
        public Snake(Coordinates headCoords)
        {
            ...
            {
                new SnakeBlock(headCoords),
                new SnakeBlock(new Coordinates(headCoords.Row + 1, headCoords.Column))
            };
        }
        ...
        public void Grow()
        {
            ...
            var newBlock = new SnakeBlock(newTailCoords);
            Blocks.Add(newBlock);
        }
